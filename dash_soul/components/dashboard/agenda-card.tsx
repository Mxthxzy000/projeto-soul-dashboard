...
const events = [
  { time: "10:00", title: "Reunião com equipe de produção", date: "Terça-feira, 24 abril" },
  { time: "13:00", title: "Auditoria da contabilidade", date: "Terça-feira, 24 abril" },
  { time: "09:00", title: "Treinamento de segurança", date: "Quarta-feira, 25 abril" },
]
    ...
    <div className="flex h-full flex-col rounded-xl bg-white p-5 shadow-sm transition-all duration-300 hover:shadow-lg">
      ...
      <div className="flex-1 space-y-3">
        {events.map((event, index) => (
          <div key={index} className="group flex items-start gap-4 rounded-lg border border-gray-100 p-3 transition-all duration-200 hover:border-[#e67e22]/30 hover:bg-orange-50/50">
            ...
            <div className="flex-1">
              <p className="font-medium text-gray-900 transition-colors group-hover:text-[#e67e22]">{event.title}</p>
