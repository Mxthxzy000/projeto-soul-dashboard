...
const shipments = [
  { id: "TN-003", date: "22/04/2024", carrier: "Transportadora Rápido", destination: "Loja Sto Pa...", status: "Em trânsito", statusColor: "bg-[#e67e22]" },
  { id: "TN-022", date: "20/04/2024", carrier: "Transportadora Velox", destination: "Distribuid. Mena", status: "Em trânsito", statusColor: "bg-[#e67e22]" },
  { id: "TN-001", date: "16/04/2024", carrier: "Transportadora Expressa", destination: "Eltai Rij...", status: "Entregue", statusColor: "bg-[#10b981]" },
  { id: "TN-000", date: "15/04/2024", carrier: "Transportadora Sul", destination: "Loja Centro", status: "Entregue", statusColor: "bg-[#10b981]" },
]

const stockItems = [
  { label: "Produtos em Estoque", value: "1,245", bgColor: "bg-[#10b981]" },
  { label: "Produtos para Repor", value: "345", bgColor: "bg-[#e67e22]" },
  { label: "Produtos Esgotados", value: "28", bgColor: "bg-[#ef4444]" },
]
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {shipments.map((shipment) => (
                  <tr key={shipment.id} className="group border-b border-gray-100 transition-colors hover:bg-gray-50">
                    <td className="py-2">
                    ...
                    <td className="py-2">
                      <span className={`inline-flex rounded-full px-2 py-1 text-xs font-medium text-white ${shipment.statusColor}`}>
                        {shipment.status}
                      </span>
                    </td>
                  </tr>
        ...
        <div className="flex flex-col">
          ...
          <div className="flex-1 space-y-3">
            {stockItems.map((item, index) => (
              <div key={index} className="group flex items-center justify-between rounded-lg border border-gray-100 p-3 transition-all duration-200 hover:border-gray-200 hover:bg-gray-50">
                <span className="text-sm text-gray-600">{item.label}</span>
                <span className={`rounded-lg px-3 py-1 text-sm font-bold text-white ${item.bgColor}`}>{item.value}</span>
              </div>
            ))}
          </div>
          <Link
